...
function randomBackgroundGradient() {
	...
	document.getElementById("secondDimensionDiv").style.background = "repeating-radial-gradient(rgba(" + a + "," + b + "," + c + ", 0.5), rgba(" + d + "," + e + "," + f + ", 0.5), rgba(" + g + "," + h + "," + i + ", 0.5), rgba(" + j + "," + k + "," + l + ", 0.5), rgba(" + m + "," + n + "," + o + ", 0.5), rgba(" + p + "," + q + "," + r + ", 0.5), rgba(" + s + "," + t + "," + u + ", 0.5), rgba(" + v + "," + w + "," + x + ", 0.5))";
	document.getElementById("thirdDimensionDiv").style.background = "repeating-radial-gradient(rgba(" + a + "," + b + "," + c + ", 0.3), rgba(" + d + "," + e + "," + f + ", 0.3), rgba(" + g + "," + h + "," + i + ", 0.3), rgba(" + j + "," + k + "," + l + ", 0.3))";
